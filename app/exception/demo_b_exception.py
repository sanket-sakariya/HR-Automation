...
class DemoBPermissionDeniedException(PermissionDeniedException):
    ...
    def __init__(self, message: str = "You do not have permission to access this demo_b."):
        super().__init__(message=message)
...
class DemoBDependencyException(ConflictException):
    ...
    def __init__(self, message: str = "Cannot delete demo_b because dependent resources exist."):
        super().__init__(message=message)
