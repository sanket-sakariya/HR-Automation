...
class BackupInfoSchema(BaseAppSchema):
    ...
    last_modified: Optional[str] = Field(
        default=None, description="Last modified timestamp", example="2024-01-14T12:00:00"
    )
...
class BackupCreateResponseSchema(BaseAppSchema):
    ...
    description: Optional[str] = Field(
        default=None, description="Backup description", example="Backup before deployment"
    )
