...
class DemoCreateSchema(BaseAppSchema):
    ...
    status: DemoStatus = Field(..., description="Current status of the entity", example=DemoStatus.CREATED)
...
class DemoUpdateSchema(BaseAppSchema):
    ...
    status: Optional[DemoStatus] = Field(default=None, description="Current status of the entity", example=DemoStatus.UPDATING)
    start_date: Optional[date] = Field(default=None, example="2023-01-01")
    social_accounts: Optional[List[SocialAccountSchema]] = Field(default=None, example=[
        {
            "platform": "twitter",
...
class DemoReadSchema(BaseAppSchema):
    ...
    demo_id: UUID = Field(..., description="Demo ID", example="a3d8f6b0-3c1b-4e6f-8a2d-9c8e7f6a5b4d")
    ...
    status: Optional[DemoStatus]  = Field(..., description="Current status of the demo", example=DemoStatus.CREATED)
