...
def generate_csv_from_schema(schema: dict, output_filename: str, base_url: str):
    ...
    with open(output_filename, 'w', newline='') as csvfile:
        ...
        # Sort paths to prioritize creation endpoints
        sorted_paths = sorted(schema.get('paths', {}).items(), key=lambda item: 'create' not in item[0].lower())
        ...
        for path, path_item in sorted_paths:
            ...
            for method, operation in path_item.items():
                ...
                headers = {
                    ...
                    'user-id': '5a7e6247-9347-4c9a-8d99-3cd125845d34',
                    'workspace-id': 'e6b0e1c5-54b8-4bf6-bb7d-5d373ca01cc0'
                }
                if 'parameters' in operation:
                    ...
                    for param in operation['parameters']:
                        if '$ref' in param:
                            ...
                            ref_param = schema.get('components', {}).get('parameters', {}).get(ref_name)
                            if ref_param:
...
if __name__ == "__main__":
    ...
    output_csv_file = 'endpoints_from_swagger.csv'
